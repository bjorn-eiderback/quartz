...
public class TriggerSeveralJobsUsingSavedData {

	public static void main (String[] args) throws Exception {
		TriggerSeveralJobsUsingSavedData example = new TriggerSeveralJobsUsingSavedData();
		example.run();
	}
